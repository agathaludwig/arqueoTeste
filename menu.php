  ...
  <div class="container" style="margin-top: 40px">
      <div class="card-deck">
        ...
        <div class="card text-center" id="sombra">
          ...
          <div class="card-footer" style="border: none; background-color: white">
            <a href="listarProjetos.php" class="btn btn-primary">Listar projetos</a>
          </div>
        </div>
        ...
        <div class="card text-center" id="sombra">
          ...
          <div class="card-footer" style="border: none; background-color: white">
            <a href="listarColecoes.php" class="btn btn-primary" style>Listar coleções</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container" style="margin-top: 40px; margin-bottom: 40px">
    <div class="card-deck">
      <div class="card text-center" id="sombra">
        ...
        <div class="card-footer" style="border: none; background-color: white">
          <a href="listarParaAnalise.php" class="btn btn-primary" style>Análise</a>
        </div>
      </div>
    </div>
  </div>
